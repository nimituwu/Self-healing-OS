...
**Phase 3 — AI-Generated Patches:** Replace hardcoded patch scripts with patches generated by a language model (Claude API + Ollama offline). Measure accuracy, recovery time, and safety against the Phase 1 baseline, evaluated within the Phase 2 safety framework.

---

## Research Context

This project is part of undergraduate research at [Siddaganga Institute of Technology](https://www.sit.ac.in/), Tumkur, Karnataka, India. The work explores practical implementation of autonomic computing concepts (IBM MAPE loop) on a real lightweight Linux distribution, establishing a verified baseline before introducing AI-driven recovery in subsequent phases.
